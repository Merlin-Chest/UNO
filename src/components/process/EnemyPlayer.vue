<template>
  <div transition="duration-500" max-h="18 sm:26" max-w="30 sm:42" min-w="26 sm:38" flex flex-col items-center text-start
    justify="center" b="dashed 4 rounded-2" :style="{
